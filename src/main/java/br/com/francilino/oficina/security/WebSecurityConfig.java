...
import br.com.francilino.oficina.log.ApplicationListenerBean;
import br.com.francilino.oficina.service.LoginService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http/*.requiresChannel().antMatchers("/*").requiresSecure()
                ...
                //PÁGINA PARA PROCESSAR A REQUISIÇÃO
                .loginProcessingUrl("/logon")
                
                //PÁGINA DE LOGIN
                .loginPage("/login")
                
                //PÁGINA PARA LOGIN BEM SUCEDIDO
                .defaultSuccessUrl("/logado")
                
                //PÁGINA PARA LOGIN MAL SUCEDIDO
